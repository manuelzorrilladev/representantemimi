...
onMounted(() => {
  ...
  console.log(element.value.children[0].offsetWidth);

  finalWidth.value = innerWidth.value * itemToShow.value + gapProp.value * (itemToShow.value);
...
<template>
  <section class="flex border flex-col justify-start items-center">
